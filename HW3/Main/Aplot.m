...
for A = [64 128 256 512]
    x = readmatrix(sprintf('xc_A%d.dat', N));
    y = readmatrix(sprintf('yc_A%d.dat', N));
    c = readmatrix(sprintf('c_A%d.dat', N));
...
saveas(f, "HW3_Error_Plot_Neumann.png", 'png')