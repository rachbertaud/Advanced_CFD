...
for N = [64 128 256 512]
    x = readmatrix(sprintf('x_with_km_N%d.dat', N));
    y = readmatrix(sprintf('y_with_km_N%d.dat', N));
    c = readmatrix(sprintf('c_with_km_N%d.dat', N));
...
saveas(f, "HW2_Error_Plot_With_Km.png", 'png')